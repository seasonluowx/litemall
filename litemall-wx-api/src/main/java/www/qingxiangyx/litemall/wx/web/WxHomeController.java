...
import www.qingxiangyx.litemall.db.service.LitemallAdService;
...
public class WxHomeController {
    ...
    public Object index(@LoginUser Integer userId) {
        ...
        FutureTask<List> seckillListTask = new FutureTask<>(secKillListCallable);
        ...
        executorService.submit(seckillListTask);
        ...
        try {
            ...
            entity.put("seckillList", seckillListTask.get());
