...
//        System.out.println(environment.getProperty(""));
        ...
        System.out.println(environment.getProperty("logging.level.www.qingxiangyx.litemall.wx"));
        System.out.println(environment.getProperty("logging.level.www.qingxiangyx.litemall.admin"));
        System.out.println(environment.getProperty("logging.level.www.qingxiangyx.litemall"));
    }
