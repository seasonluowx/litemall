...
```
org.apache.ibatis.binding.BindingException: Invalid bound statement (not found): www.qingxiangyx.litemall.db.dao.XXXX
```
...
The error may involve www.qingxiangyx.litemall.db.dao.LitemallSystemMapper.selectByExample-Inline
