...
public abstract class WxPayResult implements Serializable {
     ...
     * @return the t
     */
    public static <T extends WxPayResult> T fromXML(String xmlString, Class<T> clz) {
    ...
    public void checkResult(WxPayService wxPayService, String signType, boolean checkSuccess) throws WxPayException {
        ...
        if (checkSuccess) {
            ...
            if (!successStrings.contains(StringUtils.trimToEmpty(getReturnCode()).toUpperCase())
                ...
                throw WxPayException.newBuilder()
                        .xmlString(this.getXmlString())
                        .returnMsg(this.getReturnMsg())
                        .returnCode(this.getReturnCode())
                        .resultCode(this.getResultCode())
                        .errCode(this.getErrCode())
                        .errCodeDes(this.getErrCodeDes())
                        .build();
            }
        }
    }
