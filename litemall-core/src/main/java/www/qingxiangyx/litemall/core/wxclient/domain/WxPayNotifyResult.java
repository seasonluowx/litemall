...
public class WxPayNotifyResult extends WxPayResult {
     ...
     */
    public static com.github.binarywang.wxpay.bean.notify.WxPayOrderNotifyResult fromXML(String xmlString) {
        XStream xstream = XStreamInitializer.getInstance();
        xstream.processAnnotations(com.github.binarywang.wxpay.bean.notify.WxPayOrderNotifyResult.class);
        xstream.registerConverter(new WxPayOrderNotifyResultConverter(xstream.getMapper(), xstream.getReflectionProvider()));
        com.github.binarywang.wxpay.bean.notify.WxPayOrderNotifyResult result = (com.github.binarywang.wxpay.bean.notify.WxPayOrderNotifyResult) xstream.fromXML(xmlString);
