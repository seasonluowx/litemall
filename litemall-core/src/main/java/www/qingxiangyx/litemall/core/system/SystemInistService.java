...
import www.qingxiangyx.litemall.core.util.SystemInfoPrinter;
import www.qingxiangyx.litemall.db.service.LitemallSystemConfigService;
...
class SystemInistService {
    ...
    private Map<String, String> getSystemInfo() {
        ...
        infos.put("调试级别", environment.getProperty("logging.level.www.qingxiangyx.litemall.wx"));
